...
import kotlinx.android.synthetic.main.activity_today_todo_add.*
import java.time.LocalDate
import java.time.format.DateTimeFormatter
import java.util.*
import kotlin.math.min

class TodayTodoAddActivity : AppCompatActivity(), View.OnClickListener, TimePicker.OnTimeChangedListener {

    lateinit var time: String

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_today_todo_add)

        setSupportActionBar(today_add_layout_toolbar)
    ...
    override fun onClick(v: View?) {
        Snackbar.make(today_add_layout_toolbar, "ADD to TO DO LIST ?", Snackbar.LENGTH_SHORT).setAction("YES") {
